...
<img src='/SNOW.webp' alt='sdfd' className='w-[15px]'/>

          <span className="text-accent">+{selectedPower.capacity} $SNOW</span>
              </span>
          <span>Your Purchase of {selectedPower.xx} $SNOW is successful</span>
        </span>
        <p className="pb-6 text-[15px] w-full text-center">
          Perform more activities or buy more $SNOW to stay ahead and claim listing giveaway bonues!😎
        </p>
      </div>
      );
...
<img src='/SNOW.webp' alt='sdfd' className='w-[70px]'/>
...
<img src='/SNOW.webp' alt='sdfd' className='w-[7px]'/>
</span>
</span>
...
<img src='/SNOW.webp' alt='sdfd' className='w-[70px]'/>
                    ...
                    <p className="pb-6 text-primary text-[14px] px-4 text-center">
                      Get {selectedPower.capacity} $SNOW and boost your earnings and ranks!
                    </p>
